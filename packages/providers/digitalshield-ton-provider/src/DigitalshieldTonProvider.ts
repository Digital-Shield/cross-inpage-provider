...
type DigitalShieldTonProviderProps = IInpageProviderConfig & {
  timeout?: number;
};
...
export class ProviderTon extends ProviderTonBase implements IProviderTon {
  ...
  walletInfo?: WalletInfo = {
    name: 'DigitalShield',
    image: 'https://common.digitalshield-asset.com/logo/digitalshield-x288.png',
    about_url: 'https://digitalshield.so',
  };
  protocolVersion = 2;
  isWalletBrowser = false;

  constructor(props: DigitalShieldTonProviderProps) {
    super({
      ...props,
