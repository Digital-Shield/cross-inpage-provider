...
import { stripHexPrefix, bytesToHex } from '@digitalshieldfe/cross-inpage-provider-core';
...
import type { ProviderAptos } from './DigitalshieldAptosProvider';
...
export class AptosStandardProvider implements AptosWallet {
  readonly url: string = 'https://digitalshield.so';

  readonly options?: WalletInfo;

  readonly version = '1.0.0';

  readonly name: string = 'DigitalShield';
