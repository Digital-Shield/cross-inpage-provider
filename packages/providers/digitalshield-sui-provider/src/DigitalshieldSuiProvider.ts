import { bytesToHex } from '@digitalshieldfe/cross-inpage-provider-core';
...
import type { IJsonRpcRequest } from '@digitalshieldfe/cross-inpage-provider-types';
...
type DigitalShieldSuiSignTransactionInput = Omit<SuiSignTransactionInput, 'transaction' | 'signal'> & {
  transaction: string;
};

type DigitalShieldSuiSignAndExecuteTransactionInput = Omit<
  SuiSignAndExecuteTransactionInput,
  'transaction' | 'signal'
> & {
  transaction: string;
...
export type SuiRequest = {
  ...
  'signTransaction': (input: DigitalShieldSuiSignTransactionInput) => Promise<SignedTransaction>;

  'signAndExecuteTransaction': (
    input: DigitalShieldSuiSignAndExecuteTransactionInput,
...
export type DigitalShieldSuiProviderProps = IInpageProviderConfig & {
  timeout?: number;
};
...
class ProviderSui extends ProviderSuiBase implements IProviderSui {
  ...
  constructor(props: DigitalShieldSuiProviderProps) {
    super({
      ...props,
